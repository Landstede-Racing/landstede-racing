...
public class LogitechArxControl : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        var cbInstance = new LogitechGSDK.logiArxCB(ArxSDKCallback);
        ...
        descriptionLabel =
            "Click the left mouse button to update the progress bar, Press G to switch to a different index file, press I to go back to the original one.";
    }
    ...
    private void Update()
    {
        ...
        if (Input.GetKey(KeyCode.I)) LogitechGSDK.LogiArxSetIndex("applet.html");
        if (Input.GetKey(KeyCode.G)) LogitechGSDK.LogiArxSetIndex("gameover.html");
    }
    ...
    public static string getHtmlString()
    {
        var retStr = "";
        retStr +=
            "<html><center><body bgcolor='black'><a href='applet.html'><img src='gameover.png'/></a></body></center></html>";
        return retStr;
    }
