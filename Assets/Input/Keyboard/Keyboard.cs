...
//     version 1.11.2
//     from Assets/Input/Keyboard/Keyboard.inputactions
//
...
public partial class @Keyboard: IInputActionCollection2, IDisposable
{
    ...
    ~@Keyboard()
    {
        UnityEngine.Debug.Assert(!m_vehicleControls.enabled, "This will cause a leak and performance issues, Keyboard.vehicleControls.Disable() has not been called.");
    }
    ...
    public struct VehicleControlsActions
    {
        ...
        public VehicleControlsActions(@Keyboard wrapper) { m_Wrapper = wrapper; }
